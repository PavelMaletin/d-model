...
- Stat-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- Stat-ui: main application module, development time
- Stat-production: module that produces a production mode WAR for deployment
