...
var __gwtModuleFunction = $wnd.cvr_vist_stat_VistWidgetset;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.cvr.vist.stat.VistWidgetset=");
    idx += (13 + "cvr.vist.stat.VistWidgetset".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=cvr.vist.stat.VistWidgetset-0.js
