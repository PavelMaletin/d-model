...
public class QCellConstraint implements Serializable {
    ...
    public QCellConstraint(final int startRow, final int startCell, final int endRow, final int endCell) {
    ...
    public QCellConstraint(final int row, final int cell) {
        this.startCell = cell;
        this.endCell = cell;
        this.startRow = row;
        this.endRow = row;
    ...
    public QCellConstraint(final String constraintString) {
    ...
    public String toString() {
        return "QCellConstraint{" + "startRow=" + startRow + ", startCell=" + startCell
                + ", endRow=" + endRow + ", endCell=" + endCell + '}';
    }
}
